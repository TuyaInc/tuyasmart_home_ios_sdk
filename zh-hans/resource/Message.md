...
* [消息相关功能](#1)
    ...
    * [检查新消息](#1.3)
* [消息推送设置](#2)
    * [获取 APP 消息推送的开启状态](#2.1)
    * [开启或者关闭 APP 消息推送](#2.2)
    * [获取 APP 设备告警类推送的开启状态](#2.3)
    * [开启或者关闭 APP 设备告警推送](#2.4)
    * [获取 APP 家庭通知类推送的开启状态](#2.5)
    * [开启或者关闭 APP 家庭推送](#2.6)
    * [获取 APP 消息通知类推送的开启状态](#2.7)
    * [开启或者关闭 APP 消息通知推送](#2.8)
    * [获取 APP 营销消息类推送的开启状态](#2.9)
    * [开启或者关闭 APP 营销类消息推送](#2.10)
