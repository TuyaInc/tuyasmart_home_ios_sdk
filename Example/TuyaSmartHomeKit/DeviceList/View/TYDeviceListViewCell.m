...
- (UILabel *)groupTipLabel {
    if (!_groupTipLabel) {
        _groupTipLabel = [TPViewUtil labelWithFrame:CGRectMake(APP_CONTENT_WIDTH - 37 - 80, 0, 80, 80) fontSize:15 color:SUB_FONT_COLOR];
...
- (UILabel *)nameLabel {
    if (!_nameLabel) {
        _nameLabel = [TPViewUtil labelWithFrame:CGRectMake(100, 30, APP_CONTENT_WIDTH - 100 - 22 - 10 - 50, 20) fontSize:15 color:MAIN_FONT_COLOR];
    }
    return _nameLabel;
}
