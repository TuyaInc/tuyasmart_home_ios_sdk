...
+ (NSString *)getLanguageCode {
    NSString *lang = [[TPUtils getAppleLanguages] lowercaseString];
...
@implementation NSArray (TPJSONKit)

- (NSString *)tp_JSONString {
    return [self tp_JSONStringWithOptions:0 error:NULL];
}
...
@implementation NSDictionary (TPJSONKit)
