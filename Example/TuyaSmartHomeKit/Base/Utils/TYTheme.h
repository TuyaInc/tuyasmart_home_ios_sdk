...
//导航栏、TabBar相关
#define TOP_BAR_TEXT_COLOR          [TYTheme theme].status_font_color
#define TOP_BAR_BACKGROUND_COLOR    [TYTheme theme].status_bg_color
#define TAB_BAR_TEXT_COLOR          [TYTheme theme].navbar_font_color
#define TAB_BAR_BACKGROUND_COLOR    [TYTheme theme].navbar_bg_color


//背景颜色
#define MAIN_BACKGROUND_COLOR       [TYTheme theme].app_bg_color

//列表相关
#define LIST_MAIN_TEXT_COLOR        [TYTheme theme].list_primary_color
#define LIST_SUB_TEXT_COLOR         [TYTheme theme].list_sub_color
#define LIST_LIGHT_TEXT_COLOR       [TYTheme theme].list_secondary_color
#define LIST_LINE_COLOR             [TYTheme theme].list_line_color
#define LIST_BACKGROUND_COLOR       [TYTheme theme].list_bg_color

//提示
#define NOTICE_TEXT_COLOR           [TYTheme theme].notice_font_color
#define NOTICE_BACKGROUND_COLOR     [TYTheme theme].notice_bg_color

//按钮
#define BUTTON_TEXT_COLOR           [TYTheme theme].primary_button_font_color
#define BUTTON_BACKGROUND_COLOR     [TYTheme theme].primary_button_bg_color
#define SUB_BUTTON_TEXT_COLOR       [TYTheme theme].secondary_button_font_color
#define SUB_BUTTON_BACKGROUND_COLOR [TYTheme theme].secondary_button_bg_color
#define DISABLE_BUTTON_BACKGROUND_COLOR [TYTheme theme].disable_button_bg_color
