...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _titleLable = [TPViewUtil simpleLabel:CGRectMake(16, 14, APP_SCREEN_WIDTH - 62 - 80 - 37, 22) f:16 tc:HEXCOLOR(0x303030) t:@""];
        [self.contentView addSubview:_titleLable];
        
        _subTitleLabel = [TPViewUtil simpleLabel:CGRectMake(16, 36, APP_SCREEN_WIDTH - 62 - 80 - 37, 18) f:12 tc:HEXCOLOR(0x626262) t:@""];
