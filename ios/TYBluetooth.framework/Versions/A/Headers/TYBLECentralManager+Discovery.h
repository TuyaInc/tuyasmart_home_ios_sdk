...
/**
 ...
 @param delegate 发现代理
 */
- (void)addDiscoveryDelegate:(id<TYBLECentralManagerDiscvoeryDelegate>)delegate;
...
/**
 ...
 @param delegate 发现代理
 */
- (void)removeDiscoveryDelegate:(id<TYBLECentralManagerDiscvoeryDelegate>)delegate;
