...
@implementation TYDemoPanelBitmapViewCell
...
- (UILabel *)textLabel {
    if (!_textLabel) {
        _textLabel = [TPDemoViewUtil simpleLabel:CGRectMake(4, 0, self.borderView.width - 8, self.borderView.height) f:14 tc:HEXCOLORA(0x303030, 0.5) t:@""];
    }
    return _textLabel;
}
