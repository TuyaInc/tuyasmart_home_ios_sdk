...
@interface TYDemoPanelValueViewCell()
...
@implementation TYDemoPanelValueViewCell
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        _titleLabel = [TPDemoViewUtil simpleLabel:CGRectMake(0, 0, 56, self.bgView.height) f:18 tc:HEXCOLOR(0x303030) t:@"0"];
