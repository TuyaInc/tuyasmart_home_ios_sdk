...
@implementation TYDemoPanelEnumViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _switchLabel = [TPDemoViewUtil simpleLabel:CGRectMake(10, 0, borderView.width - 10 - 16, borderView.height) f:14 tc:HEXCOLOR(0x303030) t:@"高档"];
