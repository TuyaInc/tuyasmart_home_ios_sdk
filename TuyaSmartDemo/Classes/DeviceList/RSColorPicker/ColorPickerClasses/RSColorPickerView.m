...
//    [self.selectionLayer setNeedsDisplay];
    ...
    self.selectionColorLayer.borderWidth = 1.5;
    self.selectionColorLayer.borderColor = [UIColor colorWithRed:(255)/255.0f green:(255)/255.0f blue:(255)/255.0f alpha:(0.8)].CGColor;
...
//    [self.contentsLayer addSublayer:self.selectionLayer];
    ...
    UIPanGestureRecognizer *panRecognizer = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(panOrTapGestureRecognizer:)];
    [self addGestureRecognizer:panRecognizer];
    
    UITapGestureRecognizer *tapRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(panOrTapGestureRecognizer:)];
...
#pragma mark - Touches
- (void)panOrTapGestureRecognizer:(UIGestureRecognizer *)recognizer {
