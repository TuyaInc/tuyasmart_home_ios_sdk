...
- (void)layoutSubviews {
    ...
    if (!_topLineHidden) {
        ...
        [self addSubview:[TPDemoViewUtil viewWithFrame:CGRectMake(lineIndent, 0, lineWidth, 0.5) color:lineColor]];
    }
    ...
    if (!_bottomLineHidden) {
        ...
        [self addSubview:[TPDemoViewUtil viewWithFrame:CGRectMake(lineIndent, self.height - 0.5, lineWidth, 0.5) color:lineColor]];
    }
}
