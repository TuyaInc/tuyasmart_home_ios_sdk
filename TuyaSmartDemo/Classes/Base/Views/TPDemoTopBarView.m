...
@interface TPDemoTopBarView()

@property (nonatomic,assign) NSInteger topBarHeight;

@end

@implementation TPDemoTopBarView
...
- (void)setLeftItem:(TPDemoBarButtonItem *)leftItem {
...
- (void)setRightItem:(TPDemoBarButtonItem *)rightItem {
...
- (void)setCenterItem:(TPDemoBarButtonItem *)centerItem {
