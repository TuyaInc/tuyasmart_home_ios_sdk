...
@implementation TYDemoSmartSceneTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _titleLable = [TPDemoViewUtil simpleLabel:CGRectMake(20 + 15, ((APP_SCREEN_WIDTH - 30) * 140 / 343 - 24) / 2.0, APP_SCREEN_WIDTH - 78 - 10 - 80, 24) bf:20 tc:[UIColor whiteColor] t:@""];
