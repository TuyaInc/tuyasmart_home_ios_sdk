...
@implementation TYDemoEditSceneTableViewCell

- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        
        _titleLable = [TPDemoViewUtil simpleLabel:CGRectMake(15, 0, APP_SCREEN_WIDTH - 200, 48) f:16 tc:HEXCOLOR(0x303030) t:@""];
        [self.contentView addSubview:_titleLable];
        
        _subTitleLabel = [TPDemoViewUtil simpleLabel:CGRectMake(APP_CONTENT_WIDTH - 37 - 150, 0, 150, 48) f:14 tc:HEXCOLOR(0x9b9b9b) t:@""];
